...
<head>
<meta charset="UTF-8">
<title>응답화면으로 JSP 써보기 연습하기</title>
</head>
<body>
	...
	<form method="post" name="pizzaFrm" id="pizzaFrm" action="/order">
	  ...
	  <fieldset>
	      <legend>토핑 선택</legend>
	      <input type="checkbox" name="add" id="shrimp" value="shrimp">
	      <label for="shrimp">새우</label><br>
	      <input type="checkbox" name="add" id="sweet" value="sweet">
	      <label for="sweet">고구마</label><br>
	      <input type="checkbox" name="add" id="potato" value="potato">
	      <label for="potato">감자</label><br>
	      <input type="checkbox" name="add" id="pine" value="pine">
